[index.html](https://github.com/user-attachments/files/25956925/index.html)
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <title>Credit Risk Analyzer — Institutional Loan Scoring Engine</title>
  </head>
  <body>
    <div id="root"></div>
...
[package.json](https://github.com/user-attachments/files/25956927/package.json)
{
  ...
  "dependencies": {
    "react": "^18.2.0",
    "react-dom": "^18.2.0"
  },[vite.config.js](https://github.com/user-attachments/files/25956929/vite.config.js)import { defineConfig } from 'vite'
...
}[README.md](https://github.com/user-attachments/files/25956936/README.md)# Credit Risk Analyzer — Institutional Loan Scoring Engine
...
```bash[Uploading App.jsx…]()import { useState, useEffect, useRef, useMemo } from "react";

// ══════════════════════════════════════════════════════════════
// CREDIT RISK ANALYZER — Institutional-Grade Loan Scoring Engine
// Zero APIs · 100% Free · Built-in Risk Models![vite](https://github.com/user-attachments/assets/432908aa-fa98-4d92-9ffb-9a0cafbf6156)<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <rect width="32" height="32" rx="6" fill="#111827"/>
  <text x="16" y="22" text-anchor="middle" font-family="Arial" font-weight="900" font-size="14" fill="#00d4aa">CR</text>
</svg>
